...
function Button(props) {
  ...
  return <button type={props.type} onClick={props.onClick}  className={style}>{props.icon && <props.icon size={24} strokeWidth={1.5} className="shrink-0 relative -top-px" />}{props.buttonText}</button>;
}
